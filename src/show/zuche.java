...
public class zuche extends JFrame implements ActionListener {
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void xinXiLiuLan()//信息浏览的方法，因为删除数据后会刷新一下，自动调用此函数。
    {
        ...
        try {
            ...
            String sql= "select * from carlist  where carhire='no lend'";
            ...
            else if(!isNumeric(field.getText()))
            {
                ...
                try {
                    ...
                    if (flag == false) {
                        ...
                        if (statement.equals("lended")) {
                            JOptionPane.showMessageDialog(null, "该车辆已出租");
                        } else if (statement.equals("repairing")) {
                            JOptionPane.showMessageDialog(null, "该车辆正在修理");
                        } else {
                            String str = "update carlist set carhire='lended'where carnumber=" + field.getText() + "";
